...
const Age = () => {
  ...
  const fetchSizes = () => {
    axios
      .get(`${Base_url}/age/get?page=${currentPage}&limit=${limit}&search=${search}`)
      .then((res) => {
  ...
  return (
    <>
      <div className="flex justify-between items-center">
        <h2 className="main_title">Age</h2>
        <Button
      ...
      <AddAge  isModalOpen={isUpdateOpen}
